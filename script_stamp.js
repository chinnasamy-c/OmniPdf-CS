const fs = require('fs');
let code = fs.readFileSync('app/src/main/java/com/example/util/StampGenerator.kt', 'utf8');

// Replace the entire file
const newCode = `package com.example.util
...
`;
fs.writeFileSync('app/src/main/java/com/example/util/StampGenerator.kt', newCode);
